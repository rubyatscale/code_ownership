RSpec.describe CodeOwnership do
  ...
  describe '.validate!' do
    describe 'teams must exist validation' do
      ...
      context 'with directory with [] characters' do
        before do
      ...
      context 'with directory with [] characters containing a .codeowner file' do
        before do
      ...
      context 'with file ownership with [] characters' do
        before do
      ...
      context 'with invalid team in a file annotation' do
        before do
      ...
      context 'with invalid team in a package.yml' do
        before do
      ...
      context 'with invalid team in a package.yml using metadata' do
        before do
          write_file('packs/my_pack/package.yml', <<~CONTENTS)
            metadata:
              owner: Foo
      ...
      context 'with invalid team in a package.json' do
        before do
    ...
    context 'when file is unowned' do
      ...
      context 'with ignored file passed in that is ignored' do
        before do
  ...
  describe '.for_file' do
    ...
    describe 'path formatting expectations' do
      ...
      it 'will not find the ownership of a file that is not a cleanpath' do
        ...
        expect(CodeOwnership.for_file('./packs/my_pack/owned_file.rb')).to be_nil
      end
    end

    describe '.codeowner in a directory with [] characters' do
      before do
  ...
  describe '.for_backtrace' do
    ...
    context 'when excluded_teams is not passed in as an input parameter' do
    ...
    context 'when excluded_teams is passed in as an input parameter' do
  ...
  describe '.for_class' do
    ...
    it 'returns nil if the class constant cannot be found' do
      ...
      expect(CodeOwnership.for_class(MyFile)).to be_nil
    end
  end
  ...
  describe 'pack level ownership' do
    ...
    it 'does not create a validation error' do
      ...
      expect(validation_result.ok?).to be true
    end
  end
end
